...
class Artist(db.Model):
    ...
    mb_id = db.Column(db.String(255), nullable=False, unique=True)
...
class Album(db.Model):
    ...
    mb_album_id = db.Column(db.String(255), nullable=False, unique=True)
...
class Song(db.Model):
    ...
    mb_song_id = db.Column(db.String(255), nullable=False, unique=True)
